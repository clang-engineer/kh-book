...
import com.clangenginner.book.config.ApplicationProperties
import com.clangenginner.book.config.CRLFLogConverter
...
class KhBookApp(private val env: Environment) {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<KhBookApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(KhBookApp::class.java)
