package com.clangenginner.book.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(com.clangenginner.book.repository..*)" +
            " || within(com.clangenginner.book.service..*)" +
            " || within(com.clangenginner.book.web.rest..*)"
    )
