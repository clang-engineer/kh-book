...
import com.clangenginner.book.config.KafkaSseConsumer
import com.clangenginner.book.config.KafkaSseProducer
...
@RestController
@RequestMapping("/api/kh-book-kafka")
class KhBookKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) val output: MessageChannel) {
